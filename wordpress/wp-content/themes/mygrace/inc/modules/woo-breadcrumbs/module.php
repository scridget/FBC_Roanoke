...
if ( ! class_exists( 'Mygrace_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Mygrace_Woo_Breadcrumbs_Module class
	 */
	class Mygrace_Woo_Breadcrumbs_Module extends Mygrace_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Mygrace_WC_Breadcrumbs( $args );
