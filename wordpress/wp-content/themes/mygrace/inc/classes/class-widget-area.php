...
if ( ! class_exists( 'Mygrace_Widget_Area' ) ) {

	class Mygrace_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'mygrace-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'mygrace-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'mygrace-theme/widget_area/classes', $classes, $area_id );
	...
	function mygrace_widget_area() {
		return Mygrace_Widget_Area::get_instance();
	}
